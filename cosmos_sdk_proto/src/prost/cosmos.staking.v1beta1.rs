...
pub struct Params {
    ...
    #[prost(string, tag="10")]
    pub global_min_self_delegation: ::prost::alloc::string::String,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgCreateValidatorForOther {
    #[prost(message, optional, tag="1")]
    pub description: ::core::option::Option<Description>,
    #[prost(message, optional, tag="2")]
    pub commission: ::core::option::Option<CommissionRates>,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgCreateValidatorForOtherResponse {
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgDelegateForOther {
    #[prost(string, tag="1")]
    pub payer_address: ::prost::alloc::string::String,
    #[prost(string, tag="2")]
    pub delegator_address: ::prost::alloc::string::String,
