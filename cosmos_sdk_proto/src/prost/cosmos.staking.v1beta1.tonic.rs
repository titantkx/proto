...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn create_validator_for_other(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgCreateValidatorForOther>,
        ) -> std::result::Result<
            tonic::Response<super::MsgCreateValidatorForOtherResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/cosmos.staking.v1beta1.Msg/CreateValidatorForOther",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "cosmos.staking.v1beta1.Msg",
                        "CreateValidatorForOther",
                    ),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn delegate_for_other(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgDelegateForOther>,
        ) -> std::result::Result<
            tonic::Response<super::MsgDelegateForOtherResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/cosmos.staking.v1beta1.Msg/DelegateForOther",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("cosmos.staking.v1beta1.Msg", "DelegateForOther"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
